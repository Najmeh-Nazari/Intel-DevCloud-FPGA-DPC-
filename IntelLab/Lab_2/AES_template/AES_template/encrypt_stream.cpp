...
void AESEncrypt(unsigned char * message, unsigned char * expandedKey, unsigned char * encryptedMessage) {
	...
	for (int ii = 0; ii < 16; ii++) 
	{
		state[ii] ^= (expandedKey + (16 * (i+1)))[ii];
	}
	}
...
int main() {
	...
	cout << "=============================" << endl;
	cout << " 128-bit AES Encryption C++   " << endl;
	cout << "=============================" << endl;
	...
	if ((paddedMessageLen % 16) != 0) {
		...
		cout << "padsize:" << paddedMessageLen << endl;
	}


	
	//int paddedMessageLen = 16;
	...
	for (int i = 0; i < paddedMessageLen; i++) {
		if (i >= originalLen) {
			paddedMessage[i] = 0;
			//cout << "Pad message: " << paddedMessage[i] << endl;
		}
		else {
			//paddedMessage[i] = message[i];
			paddedMessage[i] = 40 + i;
			//cout << "Pad message: " << paddedMessage[i] << endl;
		}
	}
	...
	*/
	...
	//unsigned char * paddedMessage = new unsigned char[paddedMessageLen];
	unsigned char * paddedMessage = new unsigned char[16*end_round];

		
	memset(paddedMessage, 0, 16*end_round);
		
	for(int k =0 ; k<16 * end_round; k=k+16)
	{
		for (int j = 0; j < 16; j++) {

			paddedMessage[k+j] = 97 + j;
		}
	}

	
	
	for (int i = 0; i < 16 * end_round; i=i+16) {
